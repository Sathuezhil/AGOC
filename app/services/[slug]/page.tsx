    ...
    <>
        ...
        <div className="mx-auto max-w-6xl px-6 py-6 md:py-8">
          ...
          <div className="relative aspect-[16/10] overflow-hidden bg-night md:aspect-[16/9]">
            ...
            <div className="absolute inset-x-0 bottom-0 px-6 pb-6 md:px-10 md:pb-8">
              <p className="olive-label text-sm tracking-[0.3em] text-olive uppercase">Service</p>
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-6 py-16 lg:grid-cols-2 lg:py-20">
        ...
        <Reveal delay={120} motion="right">
          <div className="group relative aspect-[4/5] overflow-hidden md:aspect-[5/4]">
            ...
            <p className="absolute bottom-5 left-5 max-w-xs text-sm text-sand">
              {service.short}
            </p>
          </div>
        </Reveal>
      ...
      <section className="bg-night py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal>
            ...
            <h2 className="mt-3 font-display text-4xl text-white">What you get</h2>
          </Reveal>
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {service.points.map((point, i) => (
              <Reveal key={point} delay={i * 70}>
                <article className="flex h-full gap-4 border border-white/10 bg-coal/60 p-6 transition duration-500 hover:-translate-y-1 hover:border-olive/40">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-4xl text-white">The look of the work</h2>
        </Reveal>
            ...
            <Reveal key={src} delay={i * 90} className="h-full">
              <div className="group relative aspect-[4/5] overflow-hidden md:aspect-[4/5]">
                <CoverImage
                  ...
                  float={i % 2 === 0 ? "up" : "down"}
                  delay={i * 160}
                  objectPosition={i === 0 ? service.focus ?? "center 32%" : "center 32%"}
                />
          ...
          <Reveal>
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="mt-3 font-display text-4xl text-white">Other coverage</h2>
              </div>
              <Link
                href="/services"
            ...
            {others.map((item, i) => (
              <Reveal key={item.slug} delay={i * 80} className="h-full">
                <Link
                  ...
                  className="group flex h-full flex-col overflow-hidden border border-white/10 bg-coal transition-all duration-500 hover:-translate-y-1.5 hover:border-olive/50"
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-mist">{item.short}</p>
