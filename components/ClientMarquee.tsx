  ...
  return (
    <section className="clients-marquee relative overflow-hidden border-y border-sand/10 py-12 sm:py-16">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <h2 className="mt-3 text-center font-display text-3xl text-sand sm:text-4xl">
          Our clients
        </h2>
      ...
      <div className="clients-marquee-mask relative mt-9 overflow-hidden sm:mt-11">
        <div className="clients-marquee-track flex w-max items-center gap-4 sm:gap-6">
          {track.map((logo, i) => (
            <div
              key={`${logo.src}-${i}`}
              className="clients-marquee-item group relative flex h-[4.75rem] w-[10rem] shrink-0 items-center justify-center overflow-hidden rounded-xl border border-sand/10 bg-white px-4 py-3 sm:h-[5.25rem] sm:w-[11.5rem]"
              title={logo.name}
            >
