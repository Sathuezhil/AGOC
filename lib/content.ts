  ...
  about: {
    ...
    team: [
      ...
      },
      {
        ...
        bio: "Coordinates rosters, site briefings, and rapid response so every post stays covered.",
      ...
      },
      {
        ...
        bio: "Keeps officers sharp on procedure, de-escalation, and the standards clients expect.",
      ...
      },
      {
        ...
        role: "Marketing",
        bio: "Shapes AGOC’s brand presence and client-facing campaigns across Dubai and the UAE.",
